...
public class CalculateCostBasisAndProfits {
    ...
    public static double newCostBasis(int stocksOwned, int amountToBuy, double currentCostBasis, double stockPrice) {
    ...
    public static double findProfitsAfterSelling(double accountProfits, double costBasis, int stocksToSell, double currentPrice) {
