...
import digital.softwareshinobi.napkinexchange.stocks.earnings.helpers.ReleaseEarningsReport;
import digital.softwareshinobi.napkinexchange.stocks.news.helpers.RandomNewsEvents;
    ...
    public void updateNewStockInformation(boolean endOfDay) {
      //  System.out.println("hello????");
        ...
        stocks.forEach(stock -> {
            ...
            //  stock.updatePriceWithFormulaHack();
